	...
	<section class="main-slider">
		<div id="home_slider_wrapper"
			...
			<div id="home_slider"
				...
				<ul>
					<!-- SLIDE  -->
					<li data-index="rs-73" data-thumb="images/slider/slider-2.jpg"
						...
						<!-- MAIN IMAGE --> <img src="static/images/stagepic2.jpg"
						...
						<a href="search" class="tp-caption rev-btn  tp-resizeme"
						...
						style="z-index: 5; font-size: 22px; line-height: 50px; font-weight: 400; color: rgba(255, 255, 255, 1); letter-spacing: 2px; font-family: Roboto Condensed; border-color: rgb(255, 255, 255); border-style: solid; border-width: 1px 1px 1px 1px; outline: none; box-shadow: none; cursor: pointer; text-align: center">
							Search</a> <!-- LAYER NR. 3 -->
						<div class="tp-caption   tp-resizeme" id="slide-73-layer-3"
							...
							style="z-index: 7; white-space: normal; font-size: 50px; line-height: 40px; font-weight: 400; color: #ffffff; letter-spacing: 10px; font-family: Roboto Condensed;"><i>Welcome to</i> <b>Ghostlight</b>
						</div> <!-- LAYER NR. 4 -->	
					</li>
				</ul>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-4.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-5.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-6.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<span class="bage">Sale</span> <img class="img-responsive"
								src="static/images/shop/products/product-7.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-8.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-9.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
								...
								<div class="row">
									<div class="col-md-8 col-sm-6 col-xs-12">
										<div class="modal-image">
											<img class="img-responsive"
												src="static/images/shop/products/modal-product.jpg"
												alt="product-img" />
										</div>
									</div>
