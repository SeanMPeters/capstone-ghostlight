		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<h2>${msg}</h2>
					<h2>Thank you!</h2>
					<a href="home" class="btn btn-primary"><i class="tf-ion-android-arrow-back"></i>Home</a>
					<a href="profile" class="btn btn-primary"><i class="tf-ion-android-arrow-forward"></i>Profile</a>
